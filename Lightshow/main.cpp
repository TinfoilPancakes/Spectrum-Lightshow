...
/*   Updated: 2017/09/25 17:28:47 by prp              50 2E 52 2E 50          */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char const* argv[]) {
	...
	std::cout << "Starting Lights... data_ptr = " << (void*)data << std::endl;
	while (true) {
		...
		std::cout << std::setw(10) << r << ' ' << std::setw(10) << g << ' '
		          << std::setw(10) << b << '\r' << std::flush;
