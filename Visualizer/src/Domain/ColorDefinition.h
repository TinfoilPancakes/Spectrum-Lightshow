...
public:
	...
	ColorDefinition(ColorIndex color_index,
	                ColorValue red,
	                ColorValue green,
	                ColorValue blue);
	...
	inline ColorIndex get_color_index() const { return m_color_index; }

	inline ColorValue get_red() const { return m_red; }

	inline ColorValue get_green() const { return m_green; }

	inline ColorValue get_blue() const { return m_blue; }
