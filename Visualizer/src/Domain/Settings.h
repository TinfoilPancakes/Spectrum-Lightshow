...
public:
	...
	uint32_t get_fps() const noexcept { return m_fps; }

	void set_fps(const uint32_t fps) { m_fps = fps; }
	...
	void set_mpd_fifo_path(const std::string& path) { m_mpd_fifo_path = path; }
	...
	bool is_stereo_enabled() const noexcept { return m_is_stereo_enabled; }
	...
	wchar_t get_lorenz_character() const noexcept { return m_lorenz_character; }
	...
	uint32_t get_ellipse_radius() const noexcept { return m_ellipse_radius; }
