...
private:
	...
	/** PRP - BEGIN IPC INTEGRATION */

	extension::SharedMemoryObject<32768> m_shared_ext_data;

	/** PRP - END IPC INTEGRATION */
	 ...
	 */
	bool prepare_fft_input(pcm_stereo_sample* buffer,
	...
	void generate_bars(uint32_t                     number_of_bars,
	                   size_t                       fftw_results,
