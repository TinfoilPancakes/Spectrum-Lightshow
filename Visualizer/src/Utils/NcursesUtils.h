...
public:
	 ...
	 */
	static inline int32_t number_of_colors_supported() { return COLORS; }
	...
	to_ansi_color(const int16_t red, const int16_t green, const int16_t blue) {
	 ...
	 */
	static inline int32_t get_max_color() { return COLORS; }
