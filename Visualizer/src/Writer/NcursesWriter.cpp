...
void vis::NcursesWriter::write_background(int32_t              height,
                                          int32_t              width,
...
void vis::NcursesWriter::write_foreground(int32_t              height,
                                          int32_t              width,
                                          vis::ColorDefinition color,
                                          const std::wstring&  msg) {
	attron(VIS_COLOR_PAIR(color.get_color_index()));
...
void vis::NcursesWriter::write(const int32_t              row,
...
void vis::NcursesWriter::flush() { refresh(); }

vis::ColorDefinition
vis::NcursesWriter::to_color_pair(int32_t                      number,
                                  int32_t                      max,
...
vis::NcursesWriter::~NcursesWriter() { endwin(); }
