...
public:
	...
	virtual void write(int32_t             row,
	                   int32_t             column,
	 ...
	 */
	virtual ColorDefinition to_color_pair(int32_t                      number,
	                                      int32_t                      max,
...
private:
	 ...
	 */
	void write_background(int32_t              height,
	                      int32_t              width,
	 ...
	 */
	void write_foreground(int32_t              height,
	                      int32_t              width,
	                      vis::ColorDefinition color,
	                      const std::wstring&  msg);
};
