...
TEST(UtilsTest, GetStrFromStrStrUnorderedMap) {
	std::unordered_map<std::string, std::wstring> m{{"a", L"a"},
	                                                {"b", L"b"},
	                                                {"c", L"c"}};
...
TEST(UtilsTest, GetBoolFromStrStrUnorderedMap) {
	std::unordered_map<std::string, std::wstring> m{{"a", L"true"},
	                                                {"b", L"false"},
	                                                {"c", L"c"}};
...
TEST(UtilsTest, GetUintFromStrStrUnorderedMap) {
	std::unordered_map<std::string, std::wstring> m{{"a", L"1337"},
	                                                {"b", L"42"},
	                                                {"c", L"c"}};
...
TEST(UtilsTest, ToIntEmptyString) { EXPECT_EQ(0, vis::Utils::to_int("")); }
...
TEST(UtilsTest, ToIntZero) { EXPECT_EQ(0, vis::Utils::to_int("0")); }

TEST(UtilsTest, IsNumericZero) { EXPECT_TRUE(vis::Utils::is_numeric("0")); }

TEST(UtilsTest, IsNumericOne) { EXPECT_TRUE(vis::Utils::is_numeric("1")); }
...
TEST(UtilsTest, IsNumericLetter) { EXPECT_FALSE(vis::Utils::is_numeric("A")); }
